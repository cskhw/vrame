...
const tableItems = ref<IpropsTable[]>([
  ...
  },
  {
    ...
    desc: `If drawerIcons'type is string, display the user icon that in/off drawer<br/>
          If drawerIcon's type is boolean, on/off display the default icon that on/off drawer. 
    `,
  },
  {
    name: "shadow",
